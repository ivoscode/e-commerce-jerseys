      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Sports Clothing.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Sports Clothing, accessible from{" "}
            <a
              href="https://e-commerce-sports-clothing.netlify.app/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://e-commerce-sports-clothing.netlify.app/
            </a>
          </p>
        </li>
        <li>
